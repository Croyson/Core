...
object Example extends App {
  val host = flag("server", new InetSocketAddress("172.16.2.131", 3306), "mysql server address")
  val username = flag("username", "root", "mysql username")
  val password = flag("password", "123456", "mysql password")
  val dbname = flag("database", "cpdailyspace", "default database to connect to")
